...
```sh
curl -L https://codeberg.org/duras/zikh/releases/download/v0.1.1/zikh-macos-arm64 \
...
```sh
curl -L https://codeberg.org/duras/zikh/releases/download/v0.1.1/zikh-macos-amd64 \
  -o /usr/local/bin/zikh && chmod +x /usr/local/bin/zikh
```
